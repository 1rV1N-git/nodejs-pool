...
function Coin(data){
    ...
    this.donation = [
		{
            address: "GCxhhhThrVufiJSJgkLaM3dp3Vf56ZSeYXdCQBpnd3TtQiE9g6D3zzsgCaq1GMtxoVTHLAX2kY781M7CeSrntDvEMKRmjpb",
            share:100,
            name:"pool"
        }
    ];
    ...
    this.algoCheck = function(algos) {
        return algos.includes("cn/rwz") ?
               true : "algo array should include cn/rwz";
    }
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 18981: return multiHashing.cryptonight(convertedBlob, 14);      // Graft RWZ
    ...
    this.get_miner_agent_warning_notification = function(agent) {
        ...
        if (m = reXMRig.exec(agent)) {
            ...
            if (majorv + minorv + minorv2 < 10800) {
                 return "Please update your SRBminer (" + agent + ") to version v1.8.0+ ";
            }
        }
   	    return false;
    };
